...
const handleReset = async (e) => {
  ...
  return (
    <div className="container">
      ...
      <div>
        <div className="mt-4">
          <h5 className="mb-4"> Ajouter un Nouveau Emploi pour les groupes Troixiéme Année:</h5>
          <Card>
      ...
      <Card>
      <h5 className="mb-4"> Listes des Emplois pour les groupes Troixiéme Année:</h5>
        <EmploiCard/>
      </Card>
      <Card>
        <EmploiCard/>
