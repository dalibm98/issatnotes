...
const handleReset = async (e) => {
  ...
  return (
    <div className="container">
        ...
        <div className="col">
          <nav aria-label="breadcrumb" className="bg-light rounded-3 p-3 mb-4">
            <ol className="breadcrumb mb-0">
              ...
              List des Emplois Deuxiéme Année:
              </li>
            </ol>
          </nav>
        </div>
      ...
      <div>
        <div className="mt-4">
          <h5 className="mb-4"> Ajouter un Nouveau Emploi pour les groupes Deuxiéme Année:</h5>
          <Card>
            ...
            <div className="col-md-4 position-relative">
              ...
              <Form.Group controlId="formFile">
                <Form.Label>
                  Selectionné l'emploi du Deuxiéme Année sous format PDF à ajouté:
